package edu.missouri.niaaa.ema.location;
...
public class LocationUtilities {
	...
	public final static String BD_ACTION_SCHEDULE_LOCATION = "edu.missouri.niaaa.ema.SCHEDULE_LOCATION";
	public final static String ACTION_START_LOCATION = "edu.missouri.niaaa.ema.START_LOCATION";
	public final static String ACTION_STOP_LOCATION = "edu.missouri.niaaa.ema.STOP_LOCATION";
	...
	private static LocationListener locationListenerGps = new LocationListener() {
		...
		public void onProviderDisabled(String provider) {
			// Toast.makeText(serviceContext, "GPS is not enabled",
			// Toast.LENGTH_LONG).show();
		}

		@Override
		public void onProviderEnabled(String provider) {
			// Toast.makeText(serviceContext, "GPS is enabled now",
			// Toast.LENGTH_LONG).show();
		}
